export const en = {
  ...
  home: {
    ...
    description: "Discover your cosmic path with personalized Vedic astrology readings. Get insights into your career, relationships, and health from expert Pandit Ajay Shastri.",
